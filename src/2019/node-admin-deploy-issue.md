...
1. 根据最新的Pipeline ID取第一个成功的Job ID
...
- 恢复初始状态：安装node10 -> 卸载node10 -> 手动安装node7失败 -> 运维人工介入 -> 发布业务
- bug复现

2. 第二次：每次安装卸载都杀掉进程，观察是否bug复现

- 准备工作： 在第一次的基础上，停止pm2服务，杀掉所有pm2关联进程，卸载node及相关组件服务
- 安装node10
- 停止所有pm2相关服务，杀掉pm2关联进程，卸载node10
- 安装node7，自动安装失败，运维人工介入
- 发布业务
- bug消失
